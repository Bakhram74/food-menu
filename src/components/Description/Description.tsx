        ...
        <>
            {description.length > 0
                ...
                <div
                    ...
                    className={'fixed bg-black/40 w-full h-screen top-0 left-0 z-20 pt-[30vh]'}>

                    <div
                        className={'w-[500px] bg-[#FFFFE0] m-auto border-gray-400 border-2 h-[300px] rounded-3xl text-center pt-3  relative'}>
                        <CiCircleRemove size={40} className={'absolute right-2 cursor-pointer hover:scale-105 duration-300'}/>
